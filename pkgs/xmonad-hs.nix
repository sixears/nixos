...
--       , ("M-<F3>" ,
       ...
       , ("<XF86Tools>"            , spawn "${pkgs.xrandr}/bin/xrandr -o normal")
       , ("<XF86Search>"           , spawn "${pkgs.xrandr}/bin/xrandr -o right")
       , ("<XF86LaunchA>"          , spawn "${pkgs.xrandr}/bin/xrandr -o left")
       , ("<XF86Explorer>"         , spawn "${pkgs.xrandr}/bin/xrandr -o inverted")
